---
layout: default_md
title: Download Apache Artemis Console
...
This is the current Artemis Console release. For prior releases, please see the <a href="past_releases">past releases</a> page.
...
{% for current_release_prefix in site.data.current_releases["artemis_console"] %}
    {% for release in reversed_releases %}
        {% if release.version contains current_release_prefix %}
            {% include artemis_console_release.md release=release is_current_release=true latest_docs=latest_docs%}
